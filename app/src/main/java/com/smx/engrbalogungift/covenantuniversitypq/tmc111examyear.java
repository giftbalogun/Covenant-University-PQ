...
public class tmc111examyear extends AppCompatActivity {
    Toolbar mToolbar;
    ListView mListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tmc111examyear);

        mToolbar = (Toolbar) findViewById(R.id.toolbar);
        mToolbar.setTitle(getResources().getString(R.string.exam_tmc111_year));
        mListView = (ListView) findViewById(R.id.listview);
        adapter myAdapter = new adapter(tmc111examyear.this, year, subjectcolor);
