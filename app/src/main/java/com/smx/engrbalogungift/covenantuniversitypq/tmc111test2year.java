...
public class tmc111test2year extends AppCompatActivity {
    Toolbar mToolbar;
    ListView mListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tmc111test2year);

        mToolbar = (Toolbar) findViewById(R.id.toolbar);

        mListView = (ListView) findViewById(R.id.listview);
        adapter myAdapter = new adapter(tmc111test2year.this, year, subjectcolor);
