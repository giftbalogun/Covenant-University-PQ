...
public class phy111examyear extends AppCompatActivity {
    Toolbar mToolbar;
    ListView mListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phy111examyear);

        mToolbar = (Toolbar) findViewById(R.id.toolbar);
        mToolbar.setTitle(getResources().getString(R.string.exam_phy111_year));
        mListView = (ListView) findViewById(R.id.listview);
        adapter myAdapter = new adapter(phy111examyear.this, year, subjectcolor);
