...
public class phy111test2year extends AppCompatActivity {
    Toolbar mToolbar;
    ListView mListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phy111test2year);

        mToolbar = (Toolbar) findViewById(R.id.toolbar);
        mToolbar.setTitle(getResources().getString(R.string.test2_phy111_year));
        mListView = (ListView) findViewById(R.id.listview);
        adapter myAdapter = new adapter(phy111test2year.this, year, subjectcolor);
