...
public class cit111test1year extends AppCompatActivity {
    Toolbar mToolbar;
    ListView mListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cit111test1year);

        mToolbar = (Toolbar) findViewById(R.id.toolbar);
        mToolbar.setTitle(getResources().getString(R.string.cit111_year));
        mListView = (ListView) findViewById(R.id.listview);
        adapter myAdapter = new adapter(cit111test1year.this, year, subjectcolor);
