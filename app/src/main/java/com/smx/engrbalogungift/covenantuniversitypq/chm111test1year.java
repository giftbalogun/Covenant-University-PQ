...
public class chm111test1year extends AppCompatActivity {
    Toolbar mToolbar;
    ListView mListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolbar.setTitle(getResources().getString(R.string.chm111_year));
        mListView = (ListView) findViewById(R.id.listview);
        adapter myAdapter = new adapter(chm111test1year.this, year, subjectcolor);
