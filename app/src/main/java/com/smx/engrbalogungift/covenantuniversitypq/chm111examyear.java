...
public class chm111examyear extends AppCompatActivity {
    Toolbar mToolbar;
    ListView mListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chm111examyear);

        mToolbar = (Toolbar) findViewById(R.id.toolbar);
        mToolbar.setTitle(getResources().getString(R.string.exam_chm111_year));
        mListView = (ListView) findViewById(R.id.listview);
        adapter myAdapter = new adapter(chm111examyear.this, year, subjectcolor);
