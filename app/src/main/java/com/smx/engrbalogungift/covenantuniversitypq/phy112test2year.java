...
public class phy112test2year extends AppCompatActivity {
    Toolbar mToolbar;
    ListView mListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phy112test2year);

        mToolbar = (Toolbar) findViewById(R.id.toolbar);
        mToolbar.setTitle(getResources().getString(R.string.test2_phy112_year));
        mListView = (ListView) findViewById(R.id.listview);
        adapter myAdapter = new adapter(phy112test2year.this, year, subjectcolor);
