...
public class cit111examyear extends AppCompatActivity {
    Toolbar mToolbar;
    ListView mListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cit111examyear);

        mToolbar = (Toolbar) findViewById(R.id.toolbar);
        mToolbar.setTitle(getResources().getString(R.string.exam_cit111_year));
        mListView = (ListView) findViewById(R.id.listview);
        adapter myAdapter = new adapter(cit111examyear.this, year, subjectcolor);
